...
use LaravelApplicationTesting\Constraints\HasSource;
use LaravelApplicationTesting\Constraints\IsChecked;
use LaravelApplicationTesting\Constraints\HasElement;
use LaravelApplicationTesting\Constraints\IsSelected;
use LaravelApplicationTesting\Constraints\HasInElement;
use LaravelApplicationTesting\Constraints\PageConstraint;
use LaravelApplicationTesting\Constraints\ReversePageConstraint;
...
trait InteractsWithPages
{
    ...
    protected function makeRequest($method, $uri, $parameters = [], $cookies = [], $files = [])
    {
        ...
        $this->response = $this->call($method, $uri, $parameters, $cookies, $files);

        $this->clearInputs()->followAllRedirects()->assertPageLoaded($uri);
     ...
     * @return $this
     */
    protected function followAllRedirects()
    {
